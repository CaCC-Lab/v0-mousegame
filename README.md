...
- 最初から4種類のフルーツがすべて登場します。うまくいかない操作は、画面の「とりかた」と、まちがえたときのヒントで確かめられます
- ステージが進むと、出てくるフルーツの数と目標が増えていきます
...
```bash
npm run build:itch   # dist-itch/fruit-harvest-itch-<短いハッシュ>.zip
```
