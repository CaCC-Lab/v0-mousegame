export const translations = {
  ja: {
    ...
    touchDeviceNotice: 'このゲームはマウスのれんしゅうだよ。マウスがつかえるパソコンでひらいてね！',
  ...
  en: {
    ...
    touchDeviceNotice: 'This game is for practicing mouse control. Please open it on a computer with a mouse!',
